...
export default defineConfig({
  ...
  server: {
    ...
    // Target is your backend API
      '/get/thedisabilityhousingcentre': {
        target: 'https://thedisabilityhousingcentre.com.au/search-results/',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/get\/thedisabilityhousingcentre/, ''),
